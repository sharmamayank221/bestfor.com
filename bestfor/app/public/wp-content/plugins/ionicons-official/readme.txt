...
also use this plugin with HTML like this: `<i class="ion-earth"></i>`
...
4. Use the `[icon name=ionicon-here]` shortcode in the editor, or use `<i class="ioicon-here">` directly in your templates.
